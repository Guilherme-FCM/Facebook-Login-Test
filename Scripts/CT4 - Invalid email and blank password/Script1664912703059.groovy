...
WebUI.setText(findTestObject('Object Repository/Page_Entrar no Facebook/input_Entrar no Facebook_email'), 'f.uhl1997@web.de')
...
WebUI.verifyElementText(findTestObject('Page_Entrar no Facebook/div_O email que voc inseriu no est conectado a uma conta. Encontre sua conta e entre'), 
    'O email que você inseriu não está conectado a uma conta. Encontre sua conta e entre.')
